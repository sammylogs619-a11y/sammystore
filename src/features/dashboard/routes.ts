...
export const DASHBOARD_ROUTES: DashboardRouteConfig[] = [
  ...
  { path: '/foreign-numbers/:country', section: 'foreignnumbers', component: ForeignNumbersCountryPage, label: 'Foreign Numbers', requiresAuth: true },
  { path: '/my-numbers', section: 'mynumbers', component: MyNumbersPage, label: 'My Numbers', requiresAuth: true },
  { path: '/profile', section: 'profile', component: Profile, label: 'Profile', requiresAuth: true },
];
